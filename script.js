...
const contentData = {
    "pt-BR": {
        ...
        skills: [
            ...
            { category: "DevOps e Cloud", items: ["Docker", "Jenkins", "GitHub Actions", "Kubernetes", "AWS (IAM, S3, EC2, SQS)", "Linux", "Git"] },
            { category: "Observabilidade", items: ["Grafana (Dashboards de Métricas e Análise de Logs)", "Prometheus (Instrumentação de Métricas)"] },
    ...
    "en-US": {
        ...
        skills: [
            ...
            { category: "DevOps & Cloud", items: ["Docker", "Jenkins", "GitHub Actions", "Kubernetes", "AWS (IAM, S3, EC2, SQS)", "Linux", "Git"] },
            { category: "Observability", items: ["Grafana (Metrics Dashboards and Log Analysis)", "Prometheus (Metrics Instrumentation)"] },
